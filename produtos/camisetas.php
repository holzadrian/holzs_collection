...
<head>
  ...
  <title>Holz's Collection - Camisetas</title>
...
<body>
  ...
  <!-- Camisetas -->
  <section id="camisetas" class="col-lg-8 mx-auto espaco-extra">
    <h2 class="fw-normal text-center mb-5">Camisetas</h2>
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="product-card">
            <img src="../images/Ciena Lab Horse Index Heavy Tee Frente.png" data-hover="/Ciena Lab Horse Index Heavy Tee Atras.webp" class="product-image" alt="Ciena Horse Index Heavy" data-product='{"id":7,"name":"Ciena Horse Index Heavy","price":219.00,"image":"../images/Ciena Lab Horse Index Heavy Tee Frente.png","sizes":["P","M","G","GG"]}'>
